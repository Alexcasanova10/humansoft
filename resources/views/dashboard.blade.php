            ...
            <div class="col-xl-12 col-xxl-5 d-flex">
                <div class="w-100">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4  d-flex justify-content-center align-items-center bg-primary position-relative">
                        ...
                        <div class="col-4 d-flex justify-content-center align-items-center bg-danger position-relative">
                            <div class="text-center">
