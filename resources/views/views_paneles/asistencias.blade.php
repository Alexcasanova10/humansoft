    ...
    <main class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <h1 class="text-primary h3">Asistencia</h1>
            </div>
            ...
            <form class="row gy-2 gx-3 align-items-center p-4">
                ...
                <div class="col-3 d-flex justify-content-center">
                    <button type="submit" class="btn btn-primary btn-lg"
                        style="background-color: #05B82B;">Buscar</button>
                </div>
            </form>
            <div class="container mt-5 table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <!--Esta columna hace referencia al cuarto empleado-->
                        <tr>
                            <td>Arturo Ramírez</td><!-- Nombre de los empleados -->
                            <td><!-- Lista de asistencia por dia -->
                                <select class="form-control">
                                    <option disabled
                                        selected>--Selecciona--</option>
                        ...
                        <!--Esta columna hace referencia al quinto empleado-->
                        <tr>
                            <td>María López</td><!-- Nombre de los empleados -->
                            <td><!-- Lista de asistencia por dia -->
                                <select class="form-control">
                                    <option disabled
                                        selected>--Selecciona--</option>
                        ...
                        <!--Esta columna hace referencia al sexto empleado-->
                        <tr>
                            <td>Carlos García</td><!-- Nombre de los empleados -->
                            <td><!-- Lista de asistencia por dia -->
                                <select class="form-control">
                                    <option disabled
                                        selected>--Selecciona--</option>
                        ...
                        <!--Esta columna hace referencia al septimo empleado-->
                        <tr>
                            <td>Ana Fernández</td><!-- Nombre de los empleados -->
                            <td><!-- Lista de asistencia por dia -->
                                <select class="form-control">
                                    <option disabled
                                        selected>--Selecciona--</option>
                        ...
                        <!--Esta columna hace referencia al octavo empleado-->
                        <tr>
                            <td>Luisa Martínez</td><!-- Nombre de los empleados -->
                            <td><!-- Lista de asistencia por dia -->
                                <select class="form-control">
                                    <option disabled
                                        selected>--Selecciona--</option>
                        ...
                        <!--Esta columna hace referencia al noveno empleado-->
                        <tr>
                            <td>José Torres</td><!-- Nombre de los empleados -->
                            <td><!-- Lista de asistencia por dia -->
                                <select class="form-control">
                                    <option disabled
                                        selected>--Selecciona--</option>
                        ...
                        <!--Esta columna hace referencia al decimo empleado-->
                        <tr>
                            <td>Marta Rodríguez</td><!-- Nombre de los empleados -->
                            <td><!-- Lista de asistencia por dia -->
                                <select class="form-control">
                                    <option disabled
                                        selected>--Selecciona--</option>
                        ...
                        <!--Esta columna hace referencia al onceavo empleado-->
                        <tr>
                            <td>Sergio Gómez</td><!-- Nombre de los empleados -->
                            <td><!-- Lista de asistencia por dia -->
                                <select class="form-control">
                        ...
                        <!--Esta columna hace referencia al doceavo empleado-->
                        <tr>
                            <td>Elena Díaz</td><!-- Nombre de los empleados -->
                            <td><!-- Lista de asistencia por dia -->
                                <select class="form-control">
                                    <option disabled selected>--Selecciona--</option>
                                    <option value="asistencia">Asistencia</option>
